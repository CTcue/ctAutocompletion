...
// Source
// http://stackoverflow.com/a/13522838/951517
var ascii = /^[ -~]+$/;
...
***REMOVED*** Contains "unreadable" characters
***REMOVED*** TODO : for multi language support the utf8 characters must be encoded properly?
    if (! ascii.test(str))
      return "";
  ***REMOVED***
