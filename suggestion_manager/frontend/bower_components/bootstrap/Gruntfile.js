...
***REMOVED***,
    ...
    cssmin: {
      options: {
    ***REMOVED*** TODO: disable `zeroUnits` optimization once clean-css 3.2 is released
    ***REMOVED***    and then simplify the fix for https://github.com/twbs/bootstrap/issues/14837 accordingly
        compatibility: 'ie8',
        keepSpecialComments: '*',
        sourceMap: true,
        advanced: false
...
***REMOVED***
  ...
  ***REMOVED***;
  ...
  if (runSubset('core') &&
  ***REMOVED*** Skip core tests if this is a Savage build
      process.env.TRAVIS_REPO_SLUG !== 'twbs-savage/bootstrap') {
    testSubtasks = testSubtasks.concat(['dist-css', 'dist-js', 'csslint:dist', 'test-js', 'docs']);
  ***REMOVED***
  // Skip HTML validation if running a different subset of the test suite
  if (runSubset('validate-html') &&
  ***REMOVED*** Skip HTML5 validator on Travis when [skip validator] is in the commit message
      isUndefOrNonZero(process.env.TWBS_DO_VALIDATOR)) {
    testSubtasks.push('validate-html');
  ***REMOVED***
  // Only run Sauce Labs tests if there's a Sauce access key
  if (typeof process.env.SAUCE_ACCESS_KEY !== 'undefined' &&
  ***REMOVED*** Skip Sauce if running a different subset of the test suite
      runSubset('sauce-js-unit') &&
  ***REMOVED*** Skip Sauce on Travis when [skip sauce] is in the commit message
