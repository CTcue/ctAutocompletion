...
<head>
    ...
    ***REMOVED*** For Component users, it should look like this:
    ***REMOVED*** var myApp = angular.module('myApp', [require('angular-ui-router')]);
    </script>
    ...
</head>
<body>
...
<ul>
  <li ng-repeat="item in items">{{ item ***REMOVED******REMOVED***</li>
</ul>
```
...
<ul>
  <li ng-repeat="thing in things">{{ thing ***REMOVED******REMOVED***</li>
</ul>
```
...
myApp.config(function($stateProvider) {
  $stateProvider
    .state('index', {
      url: "",
      views: {
        "viewA": { template: "index.viewA" ***REMOVED***,
        "viewB": { template: "index.viewB" ***REMOVED***
  ***REMOVED***
***REMOVED***)
    .state('route1', {
      url: "/route1",
      views: {
        "viewA": { template: "route1.viewA" ***REMOVED***,
        "viewB": { template: "route1.viewB" ***REMOVED***
  ***REMOVED***
***REMOVED***)
    .state('route2', {
      url: "/route2",
      views: {
        "viewA": { template: "route2.viewA" ***REMOVED***,
        "viewB": { template: "route2.viewB" ***REMOVED***
  ***REMOVED***
***REMOVED***)
***REMOVED***);
```
